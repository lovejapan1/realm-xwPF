...
readonly SCRIPT_URL="https://raw.githubusercontent.com/lovejapan1/realm-xwPF/main/port-traffic-dog.sh"
...
show_main_menu() {
    ...
    echo -e "${GREEN}项目开源:${NC}https://github.com/lovejapan1/realm-xwPF"
...
download_notification_modules() {
    ...
    local temp_dir=$(mktemp -d)
    local repo_url="https://github.com/lovejapan1/realm-xwPF/archive/refs/heads/main.zip"
...
项目开源:<code>https://github.com/lovejapan1/realm-xwPF</code>
...
⏰ ${timestamp}
作者主页: https://zywe.de
项目开源: https://github.com/lovejapan1/realm-xwPF
一只轻巧的'守护犬'，时刻守护你的端口流量 | 快捷命令: dog
